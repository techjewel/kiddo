...
/* ---------- Focus mode ----------------------------------------
   Hide distracting chrome (score, sound, parent buttons, nav tabs,
   language switches, category pickers, shuffle buttons) so a child
   can concentrate on the current activity. The focus toggle itself
